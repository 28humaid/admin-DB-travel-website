...
export const sendAuthEmail = async (to, username, password, companyName, gstNumber) => {
  const msg = {
    ...
    // html: `<p>Hi, your username is <strong>${username}</strong> and your password is <strong>${password}</strong>.</p>`,
    html: `
    <ul>
      <li>Company Name : ${companyName}</li>
      <li>GST No.: ${gstNumber}</li>
      <li>Username: ${username}</li>
      <li>Password: ${password}</li>
    </ul>
    <h5>Use username:${username} and password:${password} for logging in</h5>
    `,
  };
